...
public class HorarioExtra  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public HorarioExtra(Persona persona, Organizacion organizacion, Date fechaInicio, Date fechaFin, String observaciones, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.persona = persona;
