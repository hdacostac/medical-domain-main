...
public class PersonaOrganizacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public PersonaOrganizacion(CategoriaPersona categoriaPersona, Persona persona, Organizacion organizacion, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.categoriaPersona = categoriaPersona;
       this.persona = persona;
       this.organizacion = organizacion;
