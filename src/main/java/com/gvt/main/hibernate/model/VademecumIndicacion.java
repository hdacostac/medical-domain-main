...
public class VademecumIndicacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public VademecumIndicacion(Vademecum vademecum, Organizacion organizacion, String indicacion, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.vademecum = vademecum;
       this.organizacion = organizacion;
       this.indicacion = indicacion;
