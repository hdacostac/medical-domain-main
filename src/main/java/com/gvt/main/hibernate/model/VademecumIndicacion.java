...
/**
 * VademecumIndicacion generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="vademecum_indicacion"
    ,schema="public"
)
public class VademecumIndicacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public VademecumIndicacion() {
    	// default constructor
    }

	
    public VademecumIndicacion(Vademecum vademecum, Organizacion organizacion, String indicacion) {
        this.vademecum = vademecum;
        this.organizacion = organizacion;
        this.indicacion = indicacion;
    }
    public VademecumIndicacion(Vademecum vademecum, Organizacion organizacion, String indicacion, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.vademecum = vademecum;
       this.organizacion = organizacion;
       this.indicacion = indicacion;
  ...
  @GenericGenerator(name = "vademecum_indicacion_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "vademecum_indicacion_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "vademecum_indicacion_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="id_vademecum", nullable=false)
...
@ManyToOne(fetch=FetchType.LAZY)
     ...
     */
     ...
     public String toString() {
      ...
      buffer.append("vademecum").append("='").append(getVademecum()).append("' ");			
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof VademecumIndicacion)) 
		 	return false;
		 	
		 VademecumIndicacion castOther = ( VademecumIndicacion ) other; 
...
// Adding extra-code
    ...
    public void cleanPOJO() {
		if(this.vademecum != null &&
			(vademecum.getId() == null || this.vademecum.getId().longValue() == 0)) {
			vademecum = null;
		}
    ...
    public VademecumIndicacion createPOJO() {
		fillPOJO();
