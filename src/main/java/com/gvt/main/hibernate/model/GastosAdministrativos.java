...
public class GastosAdministrativos  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
 	...
 	private Date fechaDesdeGastosAdministrativos;
 	@CreatedBy
    ...
    public GastosAdministrativos(float porcentajeGastosAdministrativos, Date fechaDesdeGastosAdministrativos) {
    ...
    public GastosAdministrativos(Organizacion organizacion, float porcentajeGastosAdministrativos, Date fechaDesdeGastosAdministrativos, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
...
@ManyToOne(fetch=FetchType.LAZY)
    ...
    public Date getFechaDesdeGastosAdministrativos() {
        return this.fechaDesdeGastosAdministrativos;
    }
    
    public void setFechaDesdeGastosAdministrativos(Date fechaDesdeGastosAdministrativos) {
        this.fechaDesdeGastosAdministrativos = fechaDesdeGastosAdministrativos;
    }
