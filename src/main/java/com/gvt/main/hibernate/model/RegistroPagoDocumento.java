...
public class RegistroPagoDocumento  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public RegistroPagoDocumento(OpcionSino opcionSinoByEsIslr, OpcionSino opcionSinoByEsOtroImpuesto, Documento documento, Banco banco, FormaPago formaPago, String nroOperacion, BigDecimal montoOperacion, String observaciones, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.opcionSinoByEsIslr = opcionSinoByEsIslr;
       this.opcionSinoByEsOtroImpuesto = opcionSinoByEsOtroImpuesto;
       this.documento = documento;
       this.banco = banco;
