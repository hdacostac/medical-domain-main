...
public class Timeline  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public Timeline(TipoTimeline tipoTimeline, Persona persona, Usuario usuario, String timeline) {
        this.tipoTimeline = tipoTimeline;
        this.persona = persona;
        this.usuario = usuario;
        this.timeline = timeline;
    }
    public Timeline(TipoTimeline tipoTimeline, Persona persona, Usuario usuario, String timeline, Boolean eliminado, Boolean leido, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.tipoTimeline = tipoTimeline;
       this.persona = persona;
       this.usuario = usuario;
       this.timeline = timeline;
  ...
  @GenericGenerator(name = "timeline_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "timeline_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "timeline_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
     ...
     */
     ...
     public String toString() {
      ...
      buffer.append("timeline").append("='").append(getTimeline()).append("' ");			
