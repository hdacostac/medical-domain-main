...
public class Iva  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public Iva(float porcentajeIva, Date fechaDesdeIva) {
        this.porcentajeIva = porcentajeIva;
        this.fechaDesdeIva = fechaDesdeIva;
    }
    public Iva(float porcentajeIva, Date fechaDesdeIva, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.porcentajeIva = porcentajeIva;
       this.fechaDesdeIva = fechaDesdeIva;
  ...
  @Id
    ...
    public Date getFechaDesdeIva() {
        return this.fechaDesdeIva;
    }
    
    public void setFechaDesdeIva(Date fechaDesdeIva) {
        this.fechaDesdeIva = fechaDesdeIva;
    }
