...
/**
 * RolAction generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="rol_action"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames={"id_rol", "id_action_metadata"}) 
)
public class RolAction  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public RolAction(ActionMetadata actionMetadata, Rol rol) {
        this.actionMetadata = actionMetadata;
        this.rol = rol;
    }
    public RolAction(ActionMetadata actionMetadata, Rol rol, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.actionMetadata = actionMetadata;
       this.rol = rol;
  ...
  @GenericGenerator(name = "rol_action_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "rol_action_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "rol_action_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="id_action_metadata", nullable=false)
...
@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof RolAction)) 
		 	return false;
		 	
		 RolAction castOther = ( RolAction ) other; 
