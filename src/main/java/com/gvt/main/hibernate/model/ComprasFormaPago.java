...
public class ComprasFormaPago  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public ComprasFormaPago(FormaPago formaPago, Compras compras, String nroOperacion, BigDecimal montoOperacion, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.formaPago = formaPago;
       this.compras = compras;
