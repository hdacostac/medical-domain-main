...
/**
 * ComprasFormaPago generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="compras_forma_pago"
    ,schema="public"
)
public class ComprasFormaPago  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public ComprasFormaPago(FormaPago formaPago, Compras compras, BigDecimal montoOperacion) {
        this.formaPago = formaPago;
        this.compras = compras;
        this.montoOperacion = montoOperacion;
    }
    public ComprasFormaPago(FormaPago formaPago, Compras compras, String nroOperacion, BigDecimal montoOperacion, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.formaPago = formaPago;
       this.compras = compras;
  ...
  @GenericGenerator(name = "compras_forma_pago_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "compras_forma_pago_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "compras_forma_pago_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof ComprasFormaPago)) 
		 	return false;
		 	
		 ComprasFormaPago castOther = ( ComprasFormaPago ) other; 
...
// Adding extra-code
    ...
    public ComprasFormaPago createPOJO() {
		fillPOJO();
