...
public class HorarioMedicoCota  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public HorarioMedicoCota(HorarioMedico horarioMedico, MotivoCalendario motivoCalendario, int rango, int cotaMax, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.horarioMedico = horarioMedico;
       this.motivoCalendario = motivoCalendario;
       this.rango = rango;
       this.cotaMax = cotaMax;
