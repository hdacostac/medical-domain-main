...
/**
 * HorarioMedicoCota generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="horario_medico_cota"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames={"id_horario_medico", "id_motivo_calendario", "rango"}) 
)
public class HorarioMedicoCota  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public HorarioMedicoCota() {
    	// default constructor
    }

	
    public HorarioMedicoCota(HorarioMedico horarioMedico, MotivoCalendario motivoCalendario, int rango, int cotaMax) {
        this.horarioMedico = horarioMedico;
        this.motivoCalendario = motivoCalendario;
        this.rango = rango;
        this.cotaMax = cotaMax;
    }
    public HorarioMedicoCota(HorarioMedico horarioMedico, MotivoCalendario motivoCalendario, int rango, int cotaMax, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.horarioMedico = horarioMedico;
       this.motivoCalendario = motivoCalendario;
       this.rango = rango;
       this.cotaMax = cotaMax;
  ...
  @GenericGenerator(name = "horario_medico_cota_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "horario_medico_cota_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "horario_medico_cota_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name="id_horario_medico", nullable=false)
...
@ManyToOne(fetch=FetchType.LAZY)
    ...
    @Column(name="cota_max", nullable=false)
     ...
     */
     ...
     public String toString() {
      ...
      buffer.append("horarioMedico").append("='").append(getHorarioMedico()).append("' ");			
      buffer.append("motivoCalendario").append("='").append(getMotivoCalendario()).append("' ");			
      buffer.append("rango").append("='").append(getRango()).append("' ");			
      buffer.append("cotaMax").append("='").append(getCotaMax()).append("' ");			
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof HorarioMedicoCota)) 
		 	return false;
		 	
		 HorarioMedicoCota castOther = ( HorarioMedicoCota ) other; 
...
// Adding extra-code
    ...
    public void cleanPOJO() {
		if(this.horarioMedico != null &&
			(horarioMedico.getId() == null || this.horarioMedico.getId().longValue() == 0)) {
			horarioMedico = null;
		}
    ...
    public HorarioMedicoCota createPOJO() {
		fillPOJO();
