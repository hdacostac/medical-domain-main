...
/**
 * MotivoCalendarioOrganizacion generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="motivo_calendario_organizacion"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames={"id_motivo_calendario", "id_organizacion"}) 
)
public class MotivoCalendarioOrganizacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public MotivoCalendarioOrganizacion() {
    	// default constructor
    }

	
    public MotivoCalendarioOrganizacion(MotivoCalendario motivoCalendario, Organizacion organizacion) {
        this.motivoCalendario = motivoCalendario;
        this.organizacion = organizacion;
    }
    public MotivoCalendarioOrganizacion(MotivoCalendario motivoCalendario, Organizacion organizacion, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.motivoCalendario = motivoCalendario;
       this.organizacion = organizacion;
  ...
  @GenericGenerator(name = "motivo_calendario_organizacion_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "motivo_calendario_organizacion_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "motivo_calendario_organizacion_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof MotivoCalendarioOrganizacion)) 
		 	return false;
		 	
		 MotivoCalendarioOrganizacion castOther = ( MotivoCalendarioOrganizacion ) other; 
...
// Adding extra-code
    ...
    public MotivoCalendarioOrganizacion createPOJO() {
		fillPOJO();
