...
public class MotivoCalendarioOrganizacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public MotivoCalendarioOrganizacion(MotivoCalendario motivoCalendario, Organizacion organizacion, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.motivoCalendario = motivoCalendario;
       this.organizacion = organizacion;
