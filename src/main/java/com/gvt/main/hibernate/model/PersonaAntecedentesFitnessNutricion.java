...
/**
 * PersonaAntecedentesFitnessNutricion generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="persona_antecedentes_fitness_nutricion"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames="id_persona") 
)
public class PersonaAntecedentesFitnessNutricion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
  ...
  @GenericGenerator(name = "persona_antecedentes_fitness_nutricion_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "persona_antecedentes_fitness_nutricion_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "persona_antecedentes_fitness_nutricion_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof PersonaAntecedentesFitnessNutricion)) 
		 	return false;
		 	
		 PersonaAntecedentesFitnessNutricion castOther = ( PersonaAntecedentesFitnessNutricion ) other; 
...
// Adding extra-code
    ...
    public PersonaAntecedentesFitnessNutricion createPOJO() {
		fillPOJO();
