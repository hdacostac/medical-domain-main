...
@Table(name="tipo_movimiento"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames="codigo_tipo_movimiento") 
)
public class TipoMovimiento  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public TipoMovimiento(String codigoTipoMovimiento, String nombreTipoMovimiento) {
        this.codigoTipoMovimiento = codigoTipoMovimiento;
        this.nombreTipoMovimiento = nombreTipoMovimiento;
    }
    public TipoMovimiento(String codigoTipoMovimiento, String nombreTipoMovimiento, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.codigoTipoMovimiento = codigoTipoMovimiento;
       this.nombreTipoMovimiento = nombreTipoMovimiento;
  ...
  @GenericGenerator(name = "tipo_movimiento_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "tipo_movimiento_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "tipo_movimiento_seq_gen")
  @Id
    ...
    @Column(name="codigo_tipo_movimiento", unique=true, nullable=false, length=16)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof TipoMovimiento)) 
		 	return false;
		 	
		 TipoMovimiento castOther = ( TipoMovimiento ) other; 
...
// Adding extra-code
    ...
    public TipoMovimiento createPOJO() {
		fillPOJO();
