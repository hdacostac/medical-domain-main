...
@Table(name="condicion_pago"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames="codigo_condicion_pago") 
)
public class CondicionPago  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public CondicionPago(String codigoCondicionPago, String nombreCondicionPago) {
        this.codigoCondicionPago = codigoCondicionPago;
        this.nombreCondicionPago = nombreCondicionPago;
    }
    public CondicionPago(String codigoCondicionPago, String nombreCondicionPago, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.codigoCondicionPago = codigoCondicionPago;
       this.nombreCondicionPago = nombreCondicionPago;
  ...
  @GenericGenerator(name = "condicion_pago_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "condicion_pago_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "condicion_pago_seq_gen")
  @Id
    ...
    @Column(name="codigo_condicion_pago", unique=true, nullable=false, length=16)
    ...
    @Column(name="nombre_condicion_pago", nullable=false, length=64)
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof CondicionPago)) 
		 	return false;
		 	
		 CondicionPago castOther = ( CondicionPago ) other; 
...
// Adding extra-code
    ...
    public CondicionPago createPOJO() {
		fillPOJO();
