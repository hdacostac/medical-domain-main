...
public class CondicionPago  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public CondicionPago(String codigoCondicionPago, String nombreCondicionPago, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.codigoCondicionPago = codigoCondicionPago;
       this.nombreCondicionPago = nombreCondicionPago;
