...
/**
 * Frecuencia generated by hbm2java
 */
@Entity
@EntityListeners({ AuditingEntityListener.class })
@Table(name="frecuencia"
    ,schema="public"
    , uniqueConstraints = @UniqueConstraint(columnNames="codigo_frecuencia") 
)
public class Frecuencia  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public Frecuencia(String codigoFrecuencia, String nombreFrecuencia) {
        this.codigoFrecuencia = codigoFrecuencia;
        this.nombreFrecuencia = nombreFrecuencia;
    }
    public Frecuencia(String codigoFrecuencia, String nombreFrecuencia, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.codigoFrecuencia = codigoFrecuencia;
       this.nombreFrecuencia = nombreFrecuencia;
  ...
  @GenericGenerator(name = "frecuencia_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "frecuencia_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "frecuencia_seq_gen")
  @Id
    ...
    @Column(name="codigo_frecuencia", unique=true, nullable=false, length=16)
    ...
    @Column(name="nombre_frecuencia", nullable=false, length=64)
     ...
     */
     ...
     public String toString() {
      ...
      buffer.append("codigoFrecuencia").append("='").append(getCodigoFrecuencia()).append("' ");			
      buffer.append("nombreFrecuencia").append("='").append(getNombreFrecuencia()).append("' ");			
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof Frecuencia)) 
		 	return false;
		 	
		 Frecuencia castOther = ( Frecuencia ) other; 
