...
public class TipoPrecio  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public TipoPrecio(String codigoTipoPrecio, String nombreTipoPrecio, String usuarioCreacion, Date fechaCreacion, String usuarioModificacion, Date fechaModificacion) {
       this.codigoTipoPrecio = codigoTipoPrecio;
       this.nombreTipoPrecio = nombreTipoPrecio;
